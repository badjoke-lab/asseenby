...
try {
  for (const viewport of [
    ...
    assert(!body.includes("Cat-like"), "Cat-like is still visible");
    assert(!body.includes("Bee-like"), "Bee-like is still visible");
    assert(!body.includes("Bird-like"), "Bird-like is still visible");
